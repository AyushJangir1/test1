...
class Account extends React.Component {
  ...
  handleSaveAccountDetails = () => {
    const accountDetails = {
      userRollNo: this.state.userRollNo,
      ...
      userMartialStatus: this.state.userMartialStatus,
    ...
    axios.post('/api/saveAccountDetails', accountDetails)
      .then(response => {
  ...
  render() {
    return (
      ...
      <div style={{ display: 'flex', gap: '5%', justifyContent: 'center' }}>
        {/* Save button */}
        <Button color="success" onClick={this.handleSaveAccountDetails}>Save</Button>
        {/* Reset button */}
